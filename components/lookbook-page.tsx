...
export function LookbookPage() {
  ...
  // Create a ref for the filters section
  ...
  // Function to scroll to filters section
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative h-screen bg-black text-white overflow-hidden mx-auto max-w-[95%] rounded-lg">
        <div
        ...
        <div className="relative z-10 flex h-full items-center justify-center">
          <div className="container mx-auto px-4 text-center">
            ...
            <Button
              ...
              className="bg-white px-8 py-4 text-lg font-bold uppercase tracking-wide text-black hover:bg-black hover:text-white border-2 border-white hover:scale-105 transition-all duration-300 animate-fade-in-up animation-delay-600"
            >
              Explore Collections
            </Button>
          </div>
      ...
      <div className="container mx-auto px-4 py-16 max-w-[95%]">
        {/* Filter Categories - Now with ref */}
        <div className="mb-16 text-center" ref={filtersRef}>
              ...
              <Button
                ...
                className={`transition-all duration-300 ${
                  activeCategory === category
                    ? "bg-black text-white hover:bg-white hover:text-black border-2 border-black scale-105"
                    : "border-2 border-black text-black hover:bg-black hover:text-white hover:scale-105"
                }`}
              >
                {category}
              </Button>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {filteredCollections.map((collection, index) => (
            ...
            >
              <div className={`relative overflow-hidden rounded-lg ${collection.id === 4 ? "aspect-[3/1]" : "aspect-[3/4]"}`}>
                <Image
                ...
                <div className="absolute top-4 left-4">
                  <span className="bg-white/20 backdrop-blur-sm px-3 py-1 text-xs font-semibold uppercase tracking-wide text-white rounded">
                    {collection.category}
                  </span>
                </div>
              </div>
        ...
        <div className="mt-24 text-center">
          ...
          <p className="mb-8 text-lg">
            Submit your own SACRED MAYHEM moments and get featured in our community gallery.
          </p>
          <Button
            variant="outline"
            size="lg"
            className="border-2 border-black px-8 py-4 text-lg font-bold uppercase tracking-wide text-black hover:bg-black hover:text-white hover:scale-105 transition-all duration-300 bg-transparent"
          >
            Submit Your Story
          </Button>
        </div>
