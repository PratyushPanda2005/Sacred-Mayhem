                        ...
                        <Link href={`/product/${product.id}`}>
                          <div className="relative w-full h-80 cursor-pointer">
                            <img
                              src={product.image}
                              alt={product.name}
                              className={`absolute inset-0 w-full h-full object-cover filter grayscale transition-opacity duration-500 ease-in-out ${hoveredProduct === product.id ? "opacity-0" : "opacity-100"
                                }`}
                            />
                            <img
